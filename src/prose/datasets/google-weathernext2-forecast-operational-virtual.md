...
The terms on [Google's Earth Engine catalog page for this dataset](https://developers.google.com/earth-engine/datasets/catalog/projects_gcp-public-data-weathernext_assets_weathernext_2_0_0#terms-of-use) distinguish Real-Time Experimental Data, which relates to times no more than 48 hours in the past and is governed by separate [GDM Real-Time Weather Forecasting Experimental Data Terms of Use](https://storage.googleapis.com/weathernext-public/terms-of-use.pdf), from Historic Experimental Data, which is licensed under [CC BY 4.0](https://creativecommons.org/licenses/by/4.0/). This product publishes a forecast value only once the time it relates to (initialization time plus lead time) is more than 48 hours in the past, so everything it serves is Historic Experimental Data; nothing Google classes as Real-Time Experimental Data is published here.
